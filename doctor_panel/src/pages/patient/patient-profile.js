...
import {adminFeature, appointment, patientProfile, paymentTwo} from '../../data/data'
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="rounded shadow overflow-hidden sticky-bar">
                            ...
                            <div className="text-center avatar-profile margin-nagative mt-n5 position-relative pb-4 border-bottom">
                                <img src={client1} className="rounded-circle shadow-md avatar avatar-md-md" alt=""/>
                                                    ...
                                                    <div className="col-md-12 col-lg-6 mt-4" key={index}>
                                                        <div className="card features feature-primary text-center border-0 p-4 rounded shadow">
                                                            ...
                                                            <div className="card-body p-0 mt-3">
                                                                <Link to="#" className="title text-dark h6 d-block">{item.title}</Link>
                                                                <Link to="#" className="link">Read more <FiArrowRight className="ri-arrow-right-line align-middle"/></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                )
                                    ...
                                    <div className="tab-pane fade show active">
                                        ...
                                        <div className="row align-items-center mt-4">
                                            <div className="col-lg-2 col-md-4">
                                                <img src={client1} className="avatar avatar-md-md rounded-pill shadow mx-auto d-block" alt=""/>
                                            </div>
